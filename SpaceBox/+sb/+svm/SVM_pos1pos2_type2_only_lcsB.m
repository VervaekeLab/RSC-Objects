...
%     parfor(m =1:length(timeBinSize),3)    % create non - overlapping time bins (0.19 s)
...
idxFirst = find(positionBinned >= 63-8& positionBinned <= 68+8);
idxSecond = find(positionBinned >= 100-8 & positionBinned <= 106+8);
