function [mData,data] = rsc_pupil_sessions()
%% rsc_pupil_sessions
% Load the recordings where the mouse has the whiskers intact, is running
% in darkness while the pupil ipsilateral to the landmark is imaged.
% These recordings are all at about 30 fps.

% Recordings to include
data.sessionIDs = { 'm1445_20210930_01', ... % dark
                    'm1446_20210930_01', ... % dark
                    'm1447_20210923_01', ... % dark
                    'm1445_20210915_01', ... % dark and light 
...
for s = 1:length(mData)
    ...
    % Load pupil data
    mData(s).sData = pipe.loadPupilData(mData(s).sData);
