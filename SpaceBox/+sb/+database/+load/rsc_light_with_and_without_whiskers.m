function [mData,data] = rsc_light_with_and_without_whiskers()
...
recs = {
    'm1442_20211019_01', ... % with whiskers
    'm1444_20211019_01', ... % with whiskers
    'm1445_20211019_01', ... % with whiskers
    'm1446_20211019_01', ... % with whiskers
    'm1447_20211019_01', ... % with whiskers
    'm1444_20210924_02', ... % no whiskers
    'm1442_20211005_01', ... % no whiskers
    };

% Blocked trials
%     'm5108_20210415_02', ... % whiskers
%     'm5114_20210415_01', ... % whiskers
%     'm5115_20210415_01', ... % whiskers
%     'm1445_20211004_01', ... % whiskers
%     'm1446_20211004_01', ... % whiskers
...
for s = 1:length(mData)
    for level = {'level1','level2','level3','level4'}
        ...
        pcs = sb.classify.placeTunedRoisSimple(mData(s).rmaps.(level).deconv);
        
        % Find landmark/touch cells
        lcs = sb.classify.landmarkCellsAndTraceCellsIndividualPeaks(mData(s).rmaps.(level).deconv);
